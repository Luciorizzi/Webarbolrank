...
type CampaignWithRelations = CampaignRow & { campaign_updates: UpdateRow[]; campaign_evidence: EvidenceRow[] };
...
const campaignSelect = "*, campaign_updates(*), campaign_evidence(*)";
