...
export interface Database {
  public: {
    Tables: {
      ...
      campaigns: { Row: { id: string; slug: string; title: string; location: string | null; ngo_name: string | null; goal_amount: number | null; raised_amount: number | null; impact_goal: number | null; status: CampaignStatusDb; activity_date: string | null; delivery_date: string | null; excerpt: string | null; description: string | null; cover_image_url: string | null; published_at: string | null; created_at: string; updated_at: string }; Insert: { id?: string; slug: string; title: string; status: CampaignStatusDb }; Update: { title?: string; status?: CampaignStatusDb }; Relationships: [] };
      campaign_updates: { Row: { id: string; campaign_id: string; title: string; content: string | null; event_date: string; created_at: string }; Insert: { id?: string; campaign_id: string; title: string; content?: string | null; event_date: string }; Update: { title?: string; content?: string | null; event_date?: string }; Relationships: [] };
      campaign_evidence: { Row: { id: string; campaign_id: string; type: EvidenceType; label: string; url: string | null; evidence_date: string | null; created_at: string }; Insert: { id?: string; campaign_id: string; type: EvidenceType; label: string; url?: string | null; evidence_date?: string | null }; Update: { type?: EvidenceType; label?: string; url?: string | null; evidence_date?: string | null }; Relationships: [] };
    };
